...
import { mesiConSpesaSenzaRisultatiCommerciali } from "./kpiQualita";
...
describe("mesiConSpesaSenzaRisultatiCommerciali", () => {
  it("rileva un mese con spesa ma senza nessuna riga RisultatiCommerciali", () => {
